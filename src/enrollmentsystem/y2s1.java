...
public class y2s1 {
    ...
    System.out.println("Second year first semester");
        ...
        System.out.println(" (1) ENG213 - 3 unit/s | 0 lab/s");
        System.out.println(" (2) FIL213 - 3 unit/s | 0 lab/s");
        System.out.println(" (3)  IT214 - 3 unit/s | 1 lab/s");
        System.out.println(" (4)  IT211 - 3 unit/s | 1 lab/s");
        System.out.println(" (5)  IT212 - 3 unit/s | 1 lab/s");
        System.out.println(" (6) ACC211 - 3 unit/s | 0 lab/s");
        System.out.println(" (7)  SS212 - 3 unit/s | 0 lab/s");
        System.out.println(" (8) HUM212 - 3 unit/s | 0 lab/s");
        System.out.println(" (9)  PE213 - 2 unit/s | 0 lab/s");      
        System.out.println("----------------------------------------");
        ...
        if (subjectone.equals ("1") || subjectone.equals("2") ||
            subjectone.equals("6") || subjectone.equals("7") ||
            subjectone.equals("8"))
        { 
        ...
        if (subjecttwo.equals ("1") || subjecttwo.equals("2") ||
            subjecttwo.equals("6") || subjecttwo.equals("7") ||
            subjecttwo.equals("8"))
        { 
        ...
        if (subjectthree.equals ("1") || subjectthree.equals("2") ||
            subjectthree.equals("6") || subjectthree.equals("7") ||
        ...
        if (subjectfour.equals ("1") || subjectfour.equals("2") ||
            subjectfour.equals("6") || subjectfour.equals("7") ||
        ...
        if (subjectfive.equals ("1") || subjectfive.equals("2") ||
            subjectfive.equals("6") || subjectfive.equals("7") ||
        ...
        payment6 = type0;}
            ...
            subjectsix.equals("6") || subjectsix.equals("7") ||
            subjectsix.equals("8"))
        { 
        ...
        payment7 = type0;}
            ...
            subjectseven.equals("6") || subjectseven.equals("7") ||
        ...
        payment8 = type0;}
            ...
            subjecteight.equals("6") || subjecteight.equals("7") ||
    ...
    System.out.println("Subject1: ENG213");
    System.out.println("Subject2: FIL213");
    System.out.println("Subject3: ITT214");
    System.out.println("Subject4: IT211");
    System.out.println("Subject5: IT212");
    System.out.println("Subject6: AC211");
    System.out.println("Subject7: SS212");
    System.out.println("Subject8: HUM212");
    System.out.println("Subject9: PE213");
        ...
        System.out.println("Quipper = 7500");
        System.out.println("Miscellaneous = 1500");
        System.out.println("Total units: 26");
        System.out.println("Total lab units: 3");  
        System.out.println("---------------------------------------------"); 
        System.out.println("Total: " + totalpayment);
        System.out.println("Downpayment: " + downpayment);
        System.out.println("Balance: " + balancepayment);
